...
urlpatterns = [
    ...
    path('customer/inactive_customers/', inactive_customers, name="inactive_customers"),
    path('customer/income_customers_report/' , income_customers_report , name="income_customers_report"),
    path('customer/max_income_customers_report', max_income_customers_report, name='max_income_customers_report'),
    path('daily/restrictions/report', DailyRestrictionsReport.as_view(), name='DailyRestrictionsReport'),
    path('balance_review', balance_review, name='balance_review'),
    ]